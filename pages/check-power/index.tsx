...
import { removeFromCartGA, userProperties } from "helpers/userproperties";
import {
  viewCartGA4,
  beginCheckoutGA4,
  addToCartGA4,
...
import { MobileEmptyCart } from "@lk/ui-library";
import { ServiceList } from "@lk/ui-library";
import { updateIsRTL } from "@/redux/slices/pageInfo";
import { appendScriptToDOM, hideSprinklrBot } from "containers/Base/helper";
...
import { fetchPowers } from "@/redux/slices/prescription";
                            ...
                            <div key={item.id} style={{ position: "relative" }}>
                              ...
                              >
                                <CartCard
                                  ...
                                  getPowerInfo={() => {
                                    const reqObj = {
                                      pid: parseInt(item.itemId),
                                      powerType: `power_type=${
                                        item.itemType === "Sunglasses"
                                          ? "sunglasses"
                                          : item.itemLensType
                                      }`,
                                      sessionId: sessionId,
