...
export default {
	title: "Components/V1/Checkout/AddAddressForm",
...
Overview.args = {
	...
	dataLocale: {
		...
		POWER_CHECKOUT_TEXT:"Power will be taken after checkout. No additional charges for high powers."
	},
	...
	configData: {
		DESKTOP_ADDRESS_FORM: "{\"firstName\":{\"isRendered\":true,\"disabled\":false},\"lastName\":{\"isRendered\":true,\"disabled\":false},\"gender\":{\"isRendered\":true,\"disabled\":false},\"mobile\":{\"isRendered\":true,\"disabled\":false},\"email\":{\"isRendered\":true,\"disabled\":false},\"addressLine1\":{\"isRendered\":true,\"disabled\":false},\"addressLine2\":{\"isRendered\":false,\"disabled\":false},\"zipCode\":{\"isRendered\":false,\"disabled\":false},\"cityDistrict\":{\"isRendered\":true,\"disabled\":false},\"state\":{\"isRendered\":true,\"disabled\":false,\"type\":\"input\"},\"country\":{\"isRendered\":true,\"disabled\":true},\"landmark\":{\"isRendered\":true,\"disabled\":false}}",
	}
};
